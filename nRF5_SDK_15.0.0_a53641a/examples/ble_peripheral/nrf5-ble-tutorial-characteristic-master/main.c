...
#define BUTTONTEST_1                    NRF_GPIO_PIN_MAP(0,11)
#define BUTTONTEST_2                    NRF_GPIO_PIN_MAP(0,12)

#define BUTTON_DETECTION_DELAY          APP_TIMER_TICKS(50)

#define DEVICE_NAME                     "Insight BLE Device"                       /**< Name of device. Will be included in the advertising data. */
...
static uint16_t click_counter = 0;                        /**< Click counter. */
 ...
 */
static void button_event_handler_1(uint8_t pin_no, uint8_t button_action)
{
    ...
    if (button_action == APP_BUTTON_PUSH)
    {
        ...
        click_counter++;
        our_temperature_characteristic_update_2(&m_our_service, &click_counter);
    }
 ...
 * @param[in] button_action The button action (press/release).
 */
static void button_event_handler_2(uint8_t pin_no, uint8_t button_action)
{
    ...
    if (button_action == APP_BUTTON_PUSH)
    {
        // Button pushed
        // Update characteristic value (to 1)
        our_temperature_characteristic_update_3(&m_our_service, &push);
    }
    else if (button_action == APP_BUTTON_RELEASE)
    {
        // Button released
        // Update characteristic value (to 0)
        our_temperature_characteristic_update_3(&m_our_service, &release);
    }
...
static void buttons_leds_init(void)
{
    ...
    {
        {BUTTONTEST_1, false, BUTTON_PULL, button_event_handler_1},
        {BUTTONTEST_2, false, BUTTON_PULL, button_event_handler_2}
    };
